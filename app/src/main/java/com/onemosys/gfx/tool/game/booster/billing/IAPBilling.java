package com.onemosys.gfx.tool.game.booster.billing;
...
public class IAPBilling implements PurchasesUpdatedListener, BillingClientStateListener {
    ...
    public IAPBilling(Activity activity) {
        ...
        skuListSubscriptionsList.add(AppConfig.ONE_YEAR);
    }
        ...
        if (skuListSubscriptionsList != null) {
            billingClient.queryPurchasesAsync(BillingClient.SkuType.SUBS, new PurchasesResponseListener() {
                ...
                public void onQueryPurchasesResponse(@NonNull BillingResult billingResult, @NonNull List<Purchase> list) {
                    ...
                    ((Activity)context).startActivity(new Intent(context, ControllerActivity.class));
