...
public class ControllerActivity extends AppCompatActivity{
    ...
    private void setNavigation(){
        ...
        binding.bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.dashboard: binding.mainPageView.setCurrentItem(0);
                        break;
                    case R.id.primaryGFX: binding.mainPageView.setCurrentItem(1);
                        break;
                    case R.id.secondaryGFX: binding.mainPageView.setCurrentItem(2);
                        break;
                    case R.id.stats: binding.mainPageView.setCurrentItem(3);
                        break;
                }
                return true;
            }
        ...
        binding.mainPageView.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                switch (position) {
                    case 0: runTextAnim("Welcome"); break;
                    case 1: runTextAnim("Game Settings"); break;
                    case 2: runTextAnim("Premium Files"); break;
                    case 3: runTextAnim("Stats"); break;
                }
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent intent) {
        ...
        if (requestCode == PermissionHandling.REQUEST_ACTION_OPEN_DOCUMENT_TREE_DATA && resultCode == -1) {
            ...
            //new SAFBottomsheet(context).Show(this, android_config.DATA_PERMISSION);
        }
    }
